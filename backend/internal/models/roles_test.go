...
var (
	roleDBTypes = map[string]string{`ID`: `integer`, `Name`: `character varying`, `Slug`: `character varying`, `CreatedAt`: `timestamp with time zone`, `UpdatedAt`: `timestamp with time zone`, `Deleted`: `boolean`}
	_           = bytes.MinRead
)
